...
card_json = []
r = requests.get('https://api.gwentapi.com/v0/cards/?limit=306')
cards = r.json()
for card in cards['results']:
    ...
    get_art_response = requests.get(art_request['art']['thumbnailImage'], stream=True)
